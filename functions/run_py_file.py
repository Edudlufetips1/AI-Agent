...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Runs a Python file located within the working directory and returns its stdout/stderr output.",
    parameters=types.Schema(
        ...
        properties={
            ...
            "args": types.Schema(
                ...
                description="optional CLI arguments passed to the Python script (e.g. --help, etc.)"
            )
        },
        required=["file_path"]
    ),
